...
source("main/functions/convertToRegularTimesteps.R")
...
collar_spec2 <- mutate(collar_spec, tlag = 12) #One can save processing time and avoid failures in the non-robust breakpoint-detection by specifying a fixed lag-time (may differ across collars) with the collar specification.
...
resChunk_facets <- plotCampaignConcSeries(dsChunk,res, plotsPerPage = 64L,fileName =paste0(results_dir,"/CO2_fit_facets.pdf") )
