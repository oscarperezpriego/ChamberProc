...
We extended the package *RespChamberFlux* (@RespChamberProc) by various functions...
>>>>>>> 86cae037c8eb6e140849bff0c7b49c687bdc364f
...
First, the time series of the Picarro measurement data on `r format(ds$TIMESTAMP,"%d/%m/%Y")[1]` for the study site XXX (REF to figure studysite) is shown (@fig-gas_facet).

```{r}
#| label: fig-gas_facet
#| fig-cap: Time series of various gases measured with the Picarro system 
>>>>>>> 86cae037c8eb6e140849bff0c7b49c687bdc364f
#| fig-width: 10
#| fig-height: 5
#| fig-align: center
...
The function `calcClosedChamberFlux` from *RespChamberProc* calculates the chamber flux for various gases and provides the best fit, as shown in @fig-selectedchunk for chunk '`r selected_chunk`'
